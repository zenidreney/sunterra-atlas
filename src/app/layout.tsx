          ...
          <LocationContextProvider>
            <div className="flex flex-col min-h-screen bg-linear-to-b from-yellow-50 to-orange-200">
              ...
              <main className="flex flex-col gap-3 p-1 md:p-4 md:flex-row-reverse">
                <div className="w-full md:w-2/5 bg-white/90 px-1 md:px-4 rounded-xl">
                  {children}
                </div>
                <div className="w-full md:w-3/5 h-auto px-3 md:px-0 rounded-xl overflow-hidden shadow-lg ">
                  <MapView />
                </div>
              </main>
            </div>
